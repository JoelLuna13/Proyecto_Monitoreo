...
public class Graftemp extends AppCompatActivity {
    XYPlot plot;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graftemp);
    ...
    public void gettemp(){
        ...
        try {
            ...
            //Number dato, a, k =0.20;
            Double dato, a, k =0.20;
            ...
            for(int i = 0;i<jsonArr.length();i++){
                ...
                dato = jsonObject.getDouble("temp");
            ...
            XYSeries series1 = new SimpleXYSeries(
                    Arrays.asList(series1Numbers), SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "Datos_Temperatura");
